...
- **Herramientas:** Git, GitHub, VS Code, DBeaver

---

## 🚀 Funcionalidades destacadas

- Gestión de horarios, cursos, docentes, ambientes.  
- Asginacion de carga lectiva, cursos.  
- Reportes.
---
...
-Este proyecto fue desplegado en Railway , vinculando Github y utilizando MySQL como motor de base de datos.

- El enlace de la aplicación es: https://proyectodjangosistemahorario-production.up.railway.app/
